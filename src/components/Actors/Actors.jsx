    ...
    return (
        <>
            <Grid container spacing={3}>
                ...
                <Grid style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }} item lg={7} xl={8}>
                    <Typography variant='h2' gutterBottom>{data?.name}</Typography>
                    <Typography variant='h5'>Born: {new Date(data?.birthday).toDateString()}</Typography>
